...
OPTION_SEARCH_CHANNELS = "search_channels"
OPTION_SEARCH_CHANNELS_LIMIT = "search_channels_limit"
...
DEFAULT_OPTION_SEARCH_CHANNELS = True
DEFAULT_OPTION_SEARCH_CHANNELS_LIMIT = 10
