...
| search_songs_limit | search | 15 | Limits the number of SONGS in the search result |
| search_albums | search | true | Include ALBUMS search result |
| search_albums_limit | search | 10 | Limits the number of ALBUMS in the search result |
| search_artists | search | true | Include ARTISTS search result |
| search_artists_limit | search | 10 | Limits the number of ARTISTS in the search result |
| search_movies | search | true | Include MOVIES search result |
| search_movies_limit | search | 5 | Limits the number of MOVIES in the search result |
| search_tvshows | search | true | Include TVSHOWS search result |
| search_tvshows_limit | search | 5 | Limits the number of TVSHOWS in the search result |
| search_episodes | search | true | Include EPISODES search result |
| search_episodes_limit | search | 5 | Limits the number of EPISODES in the search result |
| search_channels_tv | search | true | Include TV CHANNELS search result |
| search_channels_tv_limit | search | 10 | Limits the number of TV CHANNELS in the search result |
| search_channels_radio | search | true | Include RADIO CHANNELS search result |
| search_channels_radio_limit | search | 5 | Limits the number of RADIO CHANNELS in the search result |
